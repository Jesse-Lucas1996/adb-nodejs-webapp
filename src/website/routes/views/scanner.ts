function addTextbox(id: string, name: string, placeholder: string) {
  ...
  txtNewInputBox.innerHTML = `<input placeholder=${placeholder} class='inputField' name=${name}[] type='text'/><button class='scannerButtons' onclick=deleteTextbox(${newElementId})>Delete</button>`
